            ...
            section {
                ...
                div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--mui-space-lg);" {
                    div {
                        ...
                        (render(Props::video(
                            html! {
                                div data-mui-type="small" style="background: var(--mui-bg-input); width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; color: var(--mui-text-secondary); font-weight: var(--mui-weight-heading); " {
                                    "16:9"
                                }
                            }
                        )))
