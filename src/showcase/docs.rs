...
pub(crate) fn block_docs_source(slug: &str) -> Option<&'static str> {
    let raw = match slug {
        ...
        "feedback-notice" => include_str!("../../docs/blocks/rendered/feedback-notice.html"),
        "feedback-confirm" => include_str!("../../docs/blocks/rendered/feedback-confirm.html"),
        "search-results" => include_str!("../../docs/blocks/rendered/search-results.html"),
        "wizard-header" => include_str!("../../docs/blocks/rendered/wizard-header.html"),
        "worklist-empty" => include_str!("../../docs/blocks/rendered/worklist-empty.html"),
